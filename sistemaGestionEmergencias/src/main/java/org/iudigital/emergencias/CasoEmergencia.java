...
public class CasoEmergencia implements Comparable<CasoEmergencia> {
    ...
    public int compareTo(CasoEmergencia other) {
        ...
        double thisPriority = calculetePriorityScore();
        double otherPriority = other.calculetePriorityScore();
    ...
    private double calculetePriorityScore() {
    ...
    public Severity getSeverity() {return severidad;}
    public long getHoraRecibido() {return horaRecibido;}
    public String getLugar() {return lugar;}
    public Ambulancia getRecursoAsignado() {return recursoAsignado;}

    public void setRecursoAsignado(Ambulancia recursoAsignado) {this.recursoAsignado = recursoAsignado;}
    ...
    public long getTiempoEsperaMs() {
        if (horaInicioServicio == 0) return 0;
